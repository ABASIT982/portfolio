      ...
      >
        <div className="container mx-auto px-4 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            {/* ----- Right: Photo (Fully Blended, No Border) ----- */}
            <div className="flex justify-center order-1 lg:order-2">
              <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                {/* ----- Strong soft blur glow (blends with background) ----- */}
                <div className="absolute -inset-8 rounded-full bg-gradient-to-br from-primary/5 via-transparent to-accent/5 blur-3xl" />
